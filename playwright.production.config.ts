...
export default defineConfig({
  ...base,
  testMatch: ['**/build-entrypoints.spec.ts', '**/number-history.spec.ts', '**/cursor-style.spec.ts', '**/persistence.spec.ts', '**/npgen.spec.ts', '**/solver.spec.ts', '**/symbol-sizing-production.spec.ts', '**/special-export.spec.ts', '**/text-editing.spec.ts'],
  grep: /text-ui:|text-touch:|png:|symbol-ui:|build:|directional number insertion|marker keys|selection color|autosave survives|generates a seeded|solver:/,
