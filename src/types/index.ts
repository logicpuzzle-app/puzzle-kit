...
export type ToolType =
  ...
  | 'symbol-line'
  | 'symbol-ship_single'
  | 'symbol-ship_middle_h'
  | 'symbol-ship_middle_v'
  | 'symbol-ship_left'
  | 'symbol-ship_top'
  | 'symbol-ship_right'
  | 'symbol-ship_bottom'
  | 'symbol-water'
  | 'symbol-ship_dot'
  | 'symbol-quarter-top-left'
  | 'symbol-quarter-top-right'
  | 'symbol-quarter-bottom-right'
  | 'symbol-quarter-bottom-left'
  | 'symbol-arc-top-left'
  | 'symbol-arc-top-right'
  | 'symbol-arc-bottom-right'
  | 'symbol-arc-bottom-left'
  | 'symbol-cat'
  | 'symbol-dog'
  | 'symbol-rabbit'
  | 'symbol-bear'
