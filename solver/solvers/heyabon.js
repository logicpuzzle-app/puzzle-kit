...
export class HeyabonField {
    ...
    clone() {
        const cloned = new HeyabonField(this.height, this.width);
...
// Heyabon Solver
// ============================================
export class HeyabonSolver extends BaseSolver {
    constructor(field) {
        super(field);
    }
    static fromString(height, width, param) {
        const field = new HeyabonField(height, width);
        ...
        return new HeyabonSolver(field);
    }
...
//# sourceMappingURL=heyabon.js.map